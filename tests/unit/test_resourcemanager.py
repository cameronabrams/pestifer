...
class TestResourceManager(unittest.TestCase):
    ...
    def test_charmmff_content(self):
        ...
        self.assertTrue(RM.charmmff_content.par!=None)
        par_basenames=[os.path.basename(x) for x in RM.charmmff_content.par]
        self.assertEqual(len(set(par_basenames)),len(par_basenames))  # check for duplicates
        # self.assertTrue(RM.charmmff_content.top!=None)
        # self.assertTrue(RM.charmmff_content.toppar!=None)
        # self.assertTrue(RM.charmmff_content.streams!=None)
