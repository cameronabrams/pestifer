...
class ResidueDelete(AncestorAwareMod):
    ...
    """
    req_attr=AncestorAwareMod.req_attr+['chainID','resseqnum','insertion']
...
class ResidueDeleteList(AncestorAwareModList):
    pass
...
class Cfusion(AncestorAwareMod):
    ...
    """
    req_attr=AncestorAwareMod.req_attr+['sourcefile','sourceseg','resseqnum1','insertion1','resseqnum2','insertion2','chainID','id']
