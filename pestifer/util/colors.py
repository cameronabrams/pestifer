...
PestiferColors = dict(
    ...
    fluroescent_blue = ColorHex("#1f51ff"),
    fluroescent_green = ColorHex("#39ff14"),
    fluroescent_orange = ColorHex("#ff5f1f"),
    fluroescent_pink = ColorHex("#ff6ec7"),
    fluroescent_purple = ColorHex("#bf00ff"),
    fluroescent_red = ColorHex("#ff073a"),
    fluroescent_yellow = ColorHex("#ccff00"),
