...
def cell_to_xsc(box: np.ndarray, orig: np.ndarray, xsc: Path | str):
    """
...
def protect_str_arg(arg: str | None):
    """
...
def reduce_intlist(L: list[int]) -> str:
    """
...
#             if use_yaml_headers_as_keys and hasattr(cls,'_yaml_header'):
#                 nkey=cls._yaml_header
#             else:
#                 nkey=name
...
def replace(data: list | dict, match: str, repl: str) -> None:
    """
...
def flatten(current: dict, key: str, result: dict) -> dict:
    """
