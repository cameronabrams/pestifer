...
class CharmmParamFile:
    ...
    def write(self, filename: str, title: str = '', stamp: str = '') -> None:
        ...
        stamp : str, optional
            A provenance mark written as a second title line.  Passed in rather than looked up so
            this module stays free of pestifer-internal imports.
        """
        lines: list[str] = []
        ...
        # This file is *generated* by pestifer, so it carries the mark.  The .rtf/.str/.prm files
        # pestifer copies from the CHARMM release must never be stamped -- byte-identity with
        # upstream is how a reader verifies they are unmodified.
        if stamp:
